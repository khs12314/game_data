...
namespace game_data
{
    class PenaltyKickGame
    {
        ...
        static void enhance()
        {
            // Enhancement success probability
            double enhancementSuccessProbability = 0.5; // Initial probability

            // Generate a random number between 0 and 1 to determine enhancement success
            Random random = new Random();
            double enhancementRandomValue = random.NextDouble();
